...
/*   Updated: 2020/01/21 21:36:11 by kchen2           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void          Form::execute(Bureaucrat const & executor) const {
    if (executor.getGrade() < _GMax)
        throw GradeTooHighException();
    else if (executor.getGrade() > _GMin)
        throw GradeTooLowException();
    else if (executor.getGrade() > _GExe)
        throw "Grade too low to Execute";
    else {
        if (!_Signed)
