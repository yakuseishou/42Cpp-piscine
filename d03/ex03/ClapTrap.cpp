...
/*   Updated: 2020/01/15 15:16:36 by kchen2           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ClapTrap.hpp"

ClapTrap::ClapTrap() : _hp(0), _mHP(0),
    _ep(0), _mEP(0), _name(""), _lv(0), _mAtk(0), _rAtk(0), _dra(0) {}

ClapTrap::ClapTrap(std::string name) : _hp(100), _mHP(100),
    _ep(100), _mEP(100), _name(name), _lv(1), _mAtk(15), _rAtk(10), _dra(2) {
}
